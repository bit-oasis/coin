...
use BitOasis\Coin\Address\Validators\VergeAddressValidator;
 ...
 */
class VergeAddress implements CryptocurrencyAddress {
	...
	private function isValid($address) {
		return (new VergeAddressValidator($address))->validate();
	}
