...
use BitOasis\Coin\Address\Validators\PolygonAddressValidator;

/**
 * @author David Fiedor <davefu@seznam.cz>
 */
class PolygonAddress implements CryptocurrencyAddress {
	...
	protected function isValid($address) {
		return (new PolygonAddressValidator($address))->validate();
	}
