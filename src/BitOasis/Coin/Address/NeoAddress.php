...
use BitOasis\Coin\Address\Validators\NeoAddressValidator;
 ...
 */
class NeoAddress implements CryptocurrencyAddress {
	...
	private function isValid($address) {
		return (new NeoAddressValidator($address))->validate();
	}
