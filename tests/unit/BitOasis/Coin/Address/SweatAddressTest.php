 ...
 */
class SweatAddressTest extends UnitTest {
	 ...
	 * @throws InvalidAddressException
	 */
	protected function createAddress(string $address): SweatEconomyAddress {
		return new SweatEconomyAddress(
			$address,
			UnitTestUtils::getCryptocurrency(Cryptocurrency::SWEAT),
