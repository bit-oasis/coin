 ...
 */
class SukuAddressTest extends UnitTest {
	...
	public function providerValidate(): array {
		return [
			['0x7f0B1AE22a0BaD941694A159859d53698c94d00E'],
			['0xA9D1e08C7793af67e9d92fe308d5697FB81d3E43'],
			['0xa03400E098F4421b34a3a44A1B4e571419517687'],
			['0x45A5A83c599f02066B08f96e20fFa51763F915bB'],
	 ...
	 * @throws InvalidAddressException
	 */
	protected function createAddress(string $address): SukuAddress {
		return new SukuAddress(
			$address,
			UnitTestUtils::getCryptocurrency(Cryptocurrency::SUKU),
