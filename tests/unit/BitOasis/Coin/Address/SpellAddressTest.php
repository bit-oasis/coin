 ...
 */
class SpellAddressTest extends UnitTest {
	...
	public function providerValidate(): array {
		return [
			['0x33574204620e98BFa532E7c4994b8c588587a7e5'],
			['0x6F1cDbBb4d53d226CF4B917bF768B94acbAB6168'],
			['0x18902389d854d0CBe67840De783578656487a805'],
			['0x18902389d854d0CBe67840De783578656487a805'],
	 ...
	 * @throws InvalidAddressException
	 */
	protected function createAddress(string $address): SpellAddress {
		return new SpellAddress(
			$address,
			UnitTestUtils::getCryptocurrency(Cryptocurrency::SPELL),
