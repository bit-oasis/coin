 ...
 */
class WrappedBitcoinAddressTest extends UnitTest {
	...
	public function testAdditionalId(string $address) {
		...
		$this->assertFalse($wrappedBitcoin->supportsAdditionalId());
		$this->assertNull($wrappedBitcoin->getAdditionalIdName());
		$this->assertNull($wrappedBitcoin->getAdditionalId());
	}

	/**
	 * @param string $address
	 * @return WrappedBitcoinAddress
	 * @throws InvalidAddressException
	 */
