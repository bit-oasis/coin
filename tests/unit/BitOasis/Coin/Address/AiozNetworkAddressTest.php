 ...
 */
class AiozNetworkAddressTest extends UnitTest {
	 ...
	 * @throws InvalidAddressException
	 */
	protected function createAddress(string $address): AiozNetworkProtocolAddress {
		return new AiozNetworkProtocolAddress(
			$address,
			UnitTestUtils::getCryptocurrency(Cryptocurrency::AIOZ),
