 ...
 */
class SidusAddressTest extends UnitTest {
	...
	public function providerValidate(): array {
		return [
			...
			['0xEc86fC50261ECC1e5f625abcd8e5121ea09Eb15E'],
	 ...
	 * @throws InvalidAddressException
	 */
	protected function createAddress(string $address): SidusAddress {
		return new SidusAddress(
			$address,
			UnitTestUtils::getCryptocurrency(Cryptocurrency::SIDUS),
